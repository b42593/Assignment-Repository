...
public class ControlsLevel3 : MonoBehaviour {
	...
	void Update () {
        ...
        {
            leftpaddle.GetComponent<Rigidbody2D>().velocity = new Vector2(0f, 15f);
        ...
        {
            rightpaddle.GetComponent<Rigidbody2D>().velocity = new Vector2(0f, 15f);
